#
# Custom Makefile based of Tonc's implemention.
# (Which is mostly based on DKP's implementation.)
#
# Features very minor changes.
#
# Link to tonc: https://www.coranac.com/projects/#tonc
#
